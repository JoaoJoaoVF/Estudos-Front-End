...
/* rotas q eu adicionei*/
                    <Link to="/Todo" className="flex items-center px-4 py-2 space-x-2 text-xl text-white rounded shadow-md rtl:space-x-reverse focus:shadow decoration-none bg-primary-500 hover:bg-primary-600 centered">
                        <span i="carbon-dashboard"></span>
