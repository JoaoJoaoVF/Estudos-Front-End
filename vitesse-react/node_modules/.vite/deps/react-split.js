...
var SplitWrapper = function(superclass) {
  ...
  SplitWrapper2.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (needsRecreate) {
      ...
      this.split = split_es_default(Array.from(this.parent.children).filter(function(element) {
  ...
  SplitWrapper2.prototype.render = function render() {
    ...
    var rest = rest$1;
    return import_react.default.createElement("div", Object.assign({}, { ref: function(parent) {
...
// dep:react-split
var react_split_default = react_split_es_default;
export {
  react_split_default as default
};
